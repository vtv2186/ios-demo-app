...
clip = AudioSegment.from_file("scent_of_a_woman_future.wav",format="wav")

#clip = torchaudio.load('scent_of_a_woman_future.wav') #replace with line above
 
x = torch.FloatTensor(clip.get_array_of_samples()) 
 
 #data = torchaudio.load('scent_of_a_woman_future.wav')
...
#         # inputs = tokenizer(x, sampling_rate=16000, return_tensors='pt',padding='longest').input_values #tokenizer convert tensor into way to compute
